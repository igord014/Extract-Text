...
#Это функция, которая будет вызываться при запросе по указанному маршруту.
def extract_text():
...
# десь происходит извлечение текста из изображения. Метод image_to_string из библиотеки pytesseract используется для этой цели.
